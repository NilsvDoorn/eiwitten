...
class Option(object):
    ...
    def amino_positions(self, sequence, option):
        ...
        directions_xy = {'y_min':{'right': [-1,0,'x_min'], 'left': [1,0,'x_plus'], 'forward': [0,1,'y_min']},
        ...
        directions_z = {'z_plus':{'right': [-1,0,'x_plus'], 'left': [1,0,'x_min'], 'forward': [0,1]},
        ...
        for move in option:
            if move == 'up' or move == 'down':
                z += directions[direction[1]][move][0]
